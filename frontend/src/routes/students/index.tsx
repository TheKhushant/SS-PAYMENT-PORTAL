      ...
      <PageHeader
        ...
        actions={
          <Button onClick={() => navigate("/students/new")}>
            <Plus className="mr-2" /> New Student
          </Button>
        }
      />
                ...
                {rows.map((s) => (
                  ...
                  >
                    ...
                    <TableCell>
                      ...
                      <div className="text-xs text-muted-foreground">
                        {s.durationMonths} month{s.durationMonths > 1 ? "s" : ""}
                      </div>
                    </TableCell>
                    <TableCell>{inr(s.totals.finalFee)}</TableCell>
                    <TableCell className="text-success font-medium">{inr(s.totals.paid)}</TableCell>
                    <TableCell className={s.totals.remaining > 0 ? "text-warning font-medium" : "text-muted-foreground"}>
                      {inr(s.totals.remaining)}
                    </TableCell>
